      ...
      <div class="sections">
        <div class="card">
          ...
          <p>
            ...
            domicile pour retrouver votre mobilité et soulager vos douleurs.
          </p>
        ...
        <div class="card">
          ...
          <p>
            ...
            de gingembre pour ses propriétés anti-inflammatoires.
          </p>
          <router-link to="/products" class="btn btn-primary">Découvrir les produits</router-link>
        </div>
      </div>
    </section>
